...
defbindings("WScreen", {
   ...
   bdoc("mumble mute/unmute"),
--   kpress("AnyModifier+XF86AudioPlay", "ioncore.exec_on(_, 'mpc toggle')"),
   kpress(META.."x", "ioncore.exec_on(_, 'true')"),

   bdoc("Play"),
--   kpress("AnyModifier+XF86AudioPlay", "ioncore.exec_on(_, 'mpc toggle')"),
   --kpress(META.."Insert", "ioncore.exec_on(_, 'mpc toggle')"),
   kpress(META.."Insert", "ioncore.exec_on(_, 'spotify-cli play')"),
   bdoc("Next Track"),
--   kpress("AnyModifier+XF86AudioNext", "ioncore.exec_on(_, 'mpc next')"),
   --kpress(META.."Next", "ioncore.exec_on(_, 'mpc next')"),
   kpress(META.."Next", "ioncore.exec_on(_, 'spotify-cli next')"),
   bdoc("Prev Track"),
--   kpress("AnyModifier+XF86AudioPrev", "ioncore.exec_on(_, 'mpc prev')"),
   --kpress(META.."Prior", "ioncore.exec_on(_, 'mpc prev')"),
   kpress(META.."Prior", "ioncore.exec_on(_, 'spotify-cli prev')"),
   bdoc("Show Playlist"),
   --kpress(META.."End", "ioncore.exec_on(_, '"..XTERM.." -e ncmpcpp')"),
   ...
   --bdoc("Seek backward"),
   --kpress(META.."Left", "ioncore.exec_on(_, 'mpc seek -0:0:30')"),
   --bdoc("Stop"),
   --kpress(META.."Home", "ioncore.exec_on(_, 'mpc stop')"),
   --kpress(META.."KP_Add", "ioncore.exec_on(_, 'banshee --set-rating=5')"),
   --kpress(META.."KP_Subtract", "ioncore.exec_on(_, 'banshee --set-rating=1')"),
...
--   kpress("AnyModifier+XF86AudioRaiseVolume", "ioncore.exec_on(_, 'amixer sset Master 3%+')"),
   kpress(META.."Up", "ioncore.exec_on(_, 'pulseaudio-ctl up')"),
...
defmenu("sessionmenu", {
    ...
    menuentry("Restart xterm",    "ioncore.restart_other('xterm')"),
